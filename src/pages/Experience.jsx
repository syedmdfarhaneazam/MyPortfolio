...
const experiences = [
    {
        title: "FULL STACK INTERN @ BitByBitSolutions",
        duration: "03/2026 - 08/2026",
        location: "Remote",
        isDone: true,
        icon: Briefcase,
        pointers: [
            "Worked on the Hamara Kendra Citizen Service Retail Portal.",
            "Migrated legacy .NET application interfaces to React for improved maintainability and user experience.",
            "Developed efficient REST APIs using Python FastAPI for frontend-backend integration.",
            "Worked with PostgreSQL-backed services for data management and API operations.",
            "Designed reusable and responsive React components for long-term maintainability.",
            "Optimized API communication and application performance across different workflows.",
            "Collaborated on integrating frontend modules with backend services.",
        ],
    },
    {
        ...
        icon: Briefcase,
        pointers: [
            "Migrated an existing Flutter application from Dart to React and JavaScript.",
            "Developed reusable React components for long-term maintainability.",
            "Optimized responsive interfaces for cross-device performance.",
            "Integrated frontend applications with Python FastAPI endpoints.",
            "Implemented role-based authentication and access flows.",
            "Developed backend APIs using FastAPI and PostgreSQL.",
            "Contributed to a multi-tenant School ERP platform.",
            "Worked on AI-powered learning features and explored Generative AI and LLM-based applications.",
        ],
    },
    {
    ...
    return (
        <PageWrapper title="Experience" description="My professional journey.">
            ...
            <p className="text-center text-base sm:text-lg text-foreground/70 mb-12 sm:mb-16 max-w-3xl mx-auto px-4">
                A timeline of my professional experience — completed roles in
                green and ongoing roles in purple.
            </p>
