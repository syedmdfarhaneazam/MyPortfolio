        ...
        >
            <section className="relative min-h-[60vh] sm:min-h-[70vh] flex items-center justify-center text-center overflow-visible rounded-3xl">
                ...
                >
                    ...
                    />
                    <AnimatedText
                        text="A Creative Full-Stack Developer / Aspiring Data Scientist"
                        as="h2"
                ...
                >
                    ...
                    >
                        <p className="text-base sm:text-lg text-foreground/90 font-medium">
                            Result-driven full-stack developer proficient in
                            React.js, Tailwind CSS, Node.js, FastAPI,
                            PostgreSQL.
                        </p>
                    </motion.li>
                    <motion.li
                    ...
                    >
                        <p className="text-base sm:text-lg text-foreground/90 font-medium">
                            Solves complex problems (500+ LeetCode).
                        </p>
                    </motion.li>
                    <motion.li
                        variants={itemVariants}
                    ...
                    >
                        <p className="text-base sm:text-lg text-foreground/90 font-medium">
                            With a Infosys Spring Board GCP Certification.
                        </p>
                    </motion.li>
                    <motion.li
                        variants={itemVariants}
                    ...
                    >
                        <p className="text-base sm:text-lg text-foreground/90 font-medium">
                            Thrives in startup environments, owning end-to-end
                            features and delivering measurable impact quickly.
                        </p>
                    </motion.li>
                </motion.ul>
