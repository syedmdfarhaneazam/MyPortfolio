...
const sections = [
    {
        ...
        skills: [
            {
                name: "Python",
                pointers: ["Data Science", "NumPy", "Pandas", "FastAPI", "OOP"],
            ...
            {
                name: "JavaScript",
                pointers: ["React", "Async/Await", "DOM Manipulation", "ES6+"],
...

    {
        ...
        skills: [
            ...
            {
                name: "Linux & Shell",
                pointers: ["Linux Commands", "Cron Jobs", "WSL"],
    ...
    return (
        ...
        >
            ...
            <p className="text-center text-base sm:text-lg text-foreground/70 mb-8 sm:mb-12 max-w-2xl mx-auto px-4">
                ...
                life. I'm always learning and expanding my toolkit.
            </p>
